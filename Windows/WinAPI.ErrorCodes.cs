...
namespace zeroflag.Windows
{
	public partial class WinAPI
	{
		...
		public enum ErrorCodes : ulong
		{
			...
			/// <summary> 
			/// The version of %1 is not compatible with the version you're running. 
			...
			/// <summary> 
			/// The directory service detected a child partition below the requested new partition name. The partition hierarchy must be created in a top down method. 
			/// </summary>

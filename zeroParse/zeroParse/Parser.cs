...
namespace zeroflag.Parsing
{
	public class Parser
	{
		...
		public Token Parse(string fileName, string content, bool debug = false)
		{
			ParserContext context;
			return this.Parse(fileName, content, out context, debug);
		}

		public virtual Token Parse(string fileName, string content, out ParserContext context, bool debug = false)
		{
			content += "\0";
			if (this.Root != null)
			{
